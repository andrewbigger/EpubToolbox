...
![Toolbox Hero Shot](http://apps.biggerconcept.com/images/epubtoolbox/hero.png)
...
The pack and unpack features are wrappers around the [Zip4J](http://www.lingala.net/zip4j/) library, and handle the zipping and unzipping of non DRM protected epub files. Simply select the pack ![pack icon](https://github.com/andrewbigger/EpubToolbox/blob/master/app/src/main/resources/assets/packAction.png?raw=true) or unpack ![unpack icon](https://github.com/andrewbigger/EpubToolbox/blob/master/app/src/main/resources/assets/unpack.png?raw=true) buttons (on the top left) and follow the prompts. You'll be asked to choose your input file, then choose your output file, and the toolbox handles the rest! The pack action will also ensure that the mimetype file is uncompressed at the top of the archive as per the epub standard.

### Validators
The toolbox includes 3 validators which can be accessed from the main toolbar:
- ![epub check icon](https://github.com/andrewbigger/EpubToolbox/blob/master/app/src/main/resources/assets/checkIcon.png?raw=true) EpubCheck validator
- ![file size check icon](https://github.com/andrewbigger/EpubToolbox/blob/master/app/src/main/resources/assets/sizeCheckIcon.png?raw=true) File Size validator
- ![image size check icon](https://github.com/andrewbigger/EpubToolbox/blob/master/app/src/main/resources/assets/imageCheckIcon.png?raw=true) Image Size validator
...
Finally there is an all checks button ![all checks icon](https://github.com/andrewbigger/EpubToolbox/blob/master/app/src/main/resources/assets/allCheckIcon.png?raw=true) which runs all of the aforementioned checks on the selected file one after the other.
...
Finally the Pick Utility ![pick utility icon](https://github.com/andrewbigger/EpubToolbox/blob/master/app/src/main/resources/assets/pick.png?raw=true) allows you to provide a comma separated list of filenames that you'd like to select from a folder of epubs. 
...
```bash
cd app
mvn clean deploy -Dchannel=alpha -Dbin=osx
```
...
This project is covered by the [MIT licence](https://opensource.org/licenses/MIT), you can read it [here](https://github.com/andrewbigger/EpubToolbox/blob/master/LICENSE.md).
